...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `You are tasked with reformatting and rewriting user-provided content. Your goal is to create a clear, effective, and well-structured output that retains the ideas, message and style of the user's input.
